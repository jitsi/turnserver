...
import org.ice4j.*;
/**
 * The class would represent the FiveTuple object of TURN protocol. 
 * The hashCode function should be unique if possible 
 * since it will be used to uniquely find the allocation object.
 * 
 * @author Aakash Garg
 */
...
{
    /**
     * The <tt>Logger</tt> used by the <tt>FiveTuple</tt> class
    ...
    /**
     * @return client's port number as +ve int value or -1 if the the Client's Address has not been set.
     */
    ...
    /**
     * @return server's port number as +ve int value or -1 if the the Server's Address has not been set.
     */
