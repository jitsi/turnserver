...
{
    /**
    * The <tt>Logger</tt> used by the <tt>CreatePermissionResponseCollector</tt> class
    * and its instances for logging output.
    */
    private static final Logger logger 
	= Logger.getLogger(CreatePermissionResponseCollector.class.getName());
	    ...
	    switch(errorCodeAttribute.getErrorCode())
	    {
	    	...
	    	default : 
	    	    logger.finer("error : Received error response with error code " 
	    		    		+errorCodeAttribute.getErrorCode()
	    		    		+ evt);
	    }
	}
	else
