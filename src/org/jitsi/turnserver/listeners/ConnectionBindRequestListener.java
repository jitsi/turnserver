		...
		implements RequestListener 
{
	...
	/**
	 * The <tt>Logger</tt> used by the <tt>ConnectionBindRequestListener</tt> class
	 * and its instances for logging output.
	 */
	private static final Logger logger 
		= Logger.getLogger(ConnectionBindRequestListener.class.getName());
	...
	/**
	 * Starts this <tt>ConnectionBindRequestListener</tt>. If it is not currently
